...
class Enemy {
    ...
    update() {
        ...
        // Different patterns by changing Math.PI / #
        // this.x = canvas.width/2 * Math.sin(this.angle * Math.PI / 45) + (canvas.width/2 - this.width/2);
        // this.y = canvas.height/2 * Math.cos   (this.angle * Math.PI / 180) + (canvas.height/2 - this.height/2); 

        // this.x = canvas.width/2 * Math.sin(this.angle * Math.PI / 500) + (canvas.width/2 - this.width/2);
        // this.y = canvas.height/2 * Math.cos   (this.angle * Math.PI / 100) + (canvas.height/2 - this.height/2);   
